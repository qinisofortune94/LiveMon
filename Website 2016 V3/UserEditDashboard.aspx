                            ...
                            <div class="col-md-12 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    ...
                                    <div class="x_content">
                                        ...
                                        <div class="col-md-12">
                                            <asp:GridView ID="gridDashboards" runat="server" OnSelectedIndexChanged="gridDashboards_SelectedIndexChanged" OnPageIndexChanging="gridDashboards_PageIndexChanging"
                                        ...
                                        <div class="col-md-12">
                                            ...
                                            <div class="form-group">
                                                <div class="col-md-4 col-sm-6 col-xs-6">
                                                    ...
                                                    <asp:DropDownList ID="drpChartTypes" EnableViewState="true" runat="server" CssClass="form-control"></asp:DropDownList>
                                                </div><br />
                                            </div><br /><br />
