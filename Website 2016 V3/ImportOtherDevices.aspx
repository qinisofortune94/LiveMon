<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="ImportOtherDevices.aspx.cs" Inherits="website2016V2.IPDevices.ImportOtherDevices" %>
        ...
        <div class="panel panel-default" style="width: 1080px">
            ...
            <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne" style="padding: 1%">
                 ...
                 <div class="row">
                    ...
                    <div class="col-md-4">
                        <asp:Button ID="btnLoad" runat="server" Text="Load" Width="120px" Height="50px" class="btn btn-success form-control" BorderColor="#0099FF" OnClick="btnCreate_Click" />
                    </div>
                </div>
                    <div class="row">
                    ...
                    <div class="col-md-2"></div>
                    <div class="col-md-4">
                        <asp:Button ID="btnsubmit" runat="server" Text="Submit" Width="120px" Height="40px" class="btn btn-success form-control" BorderColor="#0099FF" OnClick="btnClear_Click" />
                    </div>
                        </div>
                <br />
