...
{
    public partial class SiteOtherDevices : System.Web.UI.Page
    {
        ...
        {
            string sqlQuery = "[Sites].[spGetAllOtherDevices]";
        ...
        {
            string sqlQuery = "[Sites].[spGetOtherDevices]";
            SqlConnection connection = new SqlConnection(conStr);
        ...
        public bool SaveSiteDevices()
        {
            ...
            try
            {
                ...
                cmd.CommandText = "[Sites].[spAddOtherDevices]";
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Connection = con;
        ...
        public bool EditSiteDevices(int id)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "[Sites].[spEditOtherDevices]";
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Connection = con;
                cmd.Parameters.Clear();
        ...
        public void Site_OtherDevices_SiteOtherDevices()
        {
            Load += Page_Load;
        }
    }
