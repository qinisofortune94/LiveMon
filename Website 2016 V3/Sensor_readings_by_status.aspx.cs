...
{
    public partial class Sensor_readings_by_status : System.Web.UI.Page, ICallbackEventHandler
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (((string)Session["LoggedIn"] == "True"))
            {
                ...
                if (IsPostBack == false)
                {
                    ...
                    {
                        chkFilter_OK.Checked = true;
                        chkFilter_NoResponse.Checked = false;
                        chkFilter_Error.Checked = false;
                        chkFilter_Alert.Checked = false;
                        chkFilter_Warning.Checked = false;
                        chkFilter_Unknown.Checked = false;
                        chkFilter_SensorWarning.Checked = false;
                        chkFilter_SensorAlert.Checked = false;
                        chkDeviceFailure.Checked = false;

                        chkFilter_NoResponse.Visible = false;
                        chkFilter_Error.Visible = false;
                        chkFilter_Alert.Visible = false;
                        chkFilter_Warning.Visible = false;
                        chkFilter_Unknown.Visible = false;
                        chkFilter_SensorWarning.Visible = false;
                        chkFilter_SensorAlert.Visible = false;
                        chkDeviceFailure.Visible = false;
                    }
                    else if (Request.QueryString["Status"] == "NoResponse")
                    {
                        chkFilter_OK.Checked = false;
                        chkFilter_NoResponse.Checked = true;
                        chkFilter_Error.Checked = false;
                        chkFilter_Alert.Checked = false;
                        chkFilter_Warning.Checked = false;
                        chkFilter_Unknown.Checked = false;
                    ...
                    else if (Request.QueryString["Status"] == "Warning")
                    {
                        chkFilter_OK.Checked = false;
                        chkFilter_NoResponse.Checked = false;
                        chkFilter_Error.Checked = false;
                        ...
                        chkFilter_Warning.Checked = false;
                        chkFilter_Unknown.Checked = false;
                        chkFilter_SensorWarning.Checked = true;
                        chkFilter_SensorAlert.Checked = false;
                        chkDeviceFailure.Checked = false;
                    ...
                    else if (Request.QueryString["Status"] == "Alert")
                    {
                        chkFilter_OK.Checked = false;
                        chkFilter_NoResponse.Checked = false;
                        chkFilter_Error.Checked = false;
                        chkFilter_Alert.Checked = true;
                        chkFilter_Warning.Checked = false;
                        chkFilter_Unknown.Checked = false;
                        chkFilter_SensorWarning.Checked = false;
                        chkFilter_SensorAlert.Checked = true;
                        chkDeviceFailure.Checked = false;
                    ...
                    else if (Request.QueryString["Status"] == "CriticalError")
                    {
                        chkFilter_OK.Checked = false;
                        chkFilter_NoResponse.Checked = false;
                        chkFilter_Error.Checked = true;
                        chkFilter_Alert.Checked = false;
                        chkFilter_Warning.Checked = false;
                        chkFilter_Unknown.Checked = false;
                        chkFilter_SensorWarning.Checked = false;
                    ...
                    else if (Request.QueryString["Status"] == "Error")
                    {
                        chkFilter_OK.Checked = false;
                        chkFilter_NoResponse.Checked = false;
                        chkFilter_Error.Checked = false;
                        chkFilter_Alert.Checked = false;
                        chkFilter_Warning.Checked = true;
                        chkFilter_Unknown.Checked = false;
                        chkFilter_SensorWarning.Checked = false;
                        chkFilter_SensorAlert.Checked = false;
                        chkDeviceFailure.Checked = false;
                    ...
                    else if (Request.QueryString["Status"] == "Disabled")
                    {
                        chkFilter_OK.Checked = false;
                        chkFilter_NoResponse.Checked = false;
                        chkFilter_Error.Checked = false;
                        ...
                        chkFilter_SensorAlert.Checked = false;
                        chkDeviceFailure.Checked = false;
                        chkFilter_Unknown.Checked = true;
                    ...
                    else if (Request.QueryString["Status"] == "DeviceFailure")
                    {
                        chkFilter_OK.Checked = false;
                        chkFilter_NoResponse.Checked = false;
                        chkFilter_Error.Checked = false;
        ...
        public void Fill_Grid()
        {
            try
            {
                    ...
                    foreach (object MyObject1_loopVariable in MyCollection)
                    {
                        ...
                        try
                        {
                            ...
                            if (MyObject1 is LiveMonitoring.IRemoteLib.SensorDetails)
                            {
                                ...
                                if (chkDeviceFailure.Checked & isAdded == false)
                                {
                                    if (MySensor.Status == LiveMonitoring.IRemoteLib.StatusDef.devicefailure)
                                    {
                                        MySensorCollection.Add(MySensor);
                                        isAdded = true;
                                    }
                ...
                MyTable = "<table id=\"myTable\" runat=\"server\" class=\"table table-striped responsive-utilities jambo_table bulk_action table-bordered panel-success col-md-12 col-sm-6 col-xs-6\" BorderColor=\"#316AC5\"><thead><tr class=\"headings\"><td><font size=4>Icon</font></td><td><font size=4>Device</font></td><td><font size=4>Sensor</font></td><td><font size=4>Field</font></td><td><font size=4>Status</font></td><td><font size=4>Value</font></td><td><font size=4>Extra Value</font></td><td><font size=4></font></td></tr></thead><tbody>";
                ...
                if ((MyCollection == null) == false)
                {
                    foreach (object MyObject1_loopVariable in MyCollection)
                    {
                        ...
                        try
                        {
                            ...
                            //lblOkay.Text = Convert.ToString(count);
        ...
        protected void export_Click(object sender, EventArgs e)
        {
            ...
            String selectedsite = cmbCurrentSite.SelectedItem.ToString();

            Response.ContentType = "application/force-download";
            Response.AddHeader("content-disposition", "attachment; filename= Sensor Details For " + selectedsite + " " + now + ".xls");
