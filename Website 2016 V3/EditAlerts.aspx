    ...
    <div class="">
                         <div class="page-title">
                                <div class="title_left">
                                    <h3>Update Or Delete Alerts</h3><br />
                                </div><br />
                        ...
                        <div class="row">
                                        ...
                                        <div class="col-md-12 col-sm-5 col-xs-12 form-group pull-right top_search">
                                            <div class="input-group">
                                                <div class="col-md-12 col-sm-5 col-xs-12 form-group pull-right top_search">
                                                    ...
                                                    <div class="col-md-6 col-sm-5 col-xs-12 form-group top_search">
                            ...
                            <div id="divSensorGrid" runat="server" visible="false" class="col-md-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2>Sensors</h2>
                                        <ul class="nav navbar-right panel_toolbox">
                            ...
                            <!-- form input mask -->
                            <div id="divAlertType" runat="server" visible="false" class="col-md-4 col-sm-12 col-xs-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                        <h2>Alert Type</h2>
                                        <ul class="nav navbar-right panel_toolbox">
                                ...
                                <!-- form color picker -->
                                <div id="divMessages" runat="server" visible="false" class="col-md-8 col-sm-12 col-xs-12">
                                    <div class="x_panel">
                                        <div class="x_title">
                                            <h2>Message</h2>
                                            <ul class="nav navbar-right panel_toolbox">
                              ...
                              <div id="divAddAlertFields" runat="server" visible="false" class="col-md-12">
                                <div class="x_panel">
                                    <div class="x_title">
                            ...
                            <div id="divLinkedContacts" runat="server" visible="false" class="col-md-12">
                                <div class="x_panel">
                                    <div class="x_title">
                                    ...
                                    <div class="x_content">
                                        <div class="col-md-12">
                                              <asp:GridView ID="GridContacts" runat="server" AutoGenerateDeleteButton="True"
                                            ...
                                            <div class="col-md-8 col-sm-6 col-xs-6">
                                                ...
                                                <asp:Button ID="btnUpdateThreashholds" CssClass="btn btn-success" runat="server" Text="Update Threashholds" Width="167px" Visible="false">
                                                </asp:Button>
