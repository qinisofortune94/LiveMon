    ...
    public partial class ActiveDirectoryUnits : System.Web.UI.Page
    {
        ...
        protected void GridView1_PreRender(object sender, EventArgs e)
        {
            if (Page.IsPostBack == false)
            {
                ...
                {
                    lblSuccess.Text = "Error Loading Sites";
                }
            }
        ...
        public bool CanSave()
        {
            ...
            {
                lblSuccess.Text = "Please enter unit name.";
                txtUnit.Focus();
                return false;
            }
            ...
            {
                lblSuccess.Text = "Please select a valid site.";
                drpSites.Focus();
                return false;
            }
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            if (CanSave())
            {
                ...
                if (temp.Contains("Add"))
                {
                    ...
                    {
                        lblSuccess.Text = "An error occured while trying to save unit, please try again.";
                    }
                }
