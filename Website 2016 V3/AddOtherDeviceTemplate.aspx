<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="AddOtherDeviceTemplate.aspx.cs" Inherits="website2016V2.IPDevices.AddOtherDeviceTemplate" %>
        ...
        <div class="panel panel-default" style="width: 1080px">
            <div class="panel-heading" role="tab" id="headingOne">
                <h4 class="panel-title">
                    <a id="first" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="false" aria-controls="collapseOne"><strong>
                        <asp:Label ID="lblAdd" runat="server" Text="Add Device Template"></asp:Label>
                    </strong>
                    </a>
                </h4>
            </div>
            <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne" style="padding: 1%">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <asp:TextBox ID="txtName" runat="server" PlaceHolder="Please enter  name" required="true" CssClass="form-control" Width="250px" Height="34px"></asp:TextBox>
                    </div>
                   
                    <div class="col-md-2">TCP Port:</div>
                    <div class="col-md-4">
                        <asp:TextBox ID="txtSurname" runat="server" PlaceHolder="Please enter surname" required="true" CssClass="form-control" Width="250px" Height="34px"></asp:TextBox>
                    </div>
                </div>
                  <div class="row">
                     <div class="col-md-2">BaudRate :</div>
                    <div class="col-md-4">
                          <asp:DropDownList ID="ddlBaudRate" runat="server" PlaceHolder="Please select rate" required="true" CssClass="form-control" Width="250px" Height="34px"></asp:DropDownList> 
                    </div>
                    <div class="col-md-2">	SerialPort :</div>
                    <div class="col-md-4">
                            <asp:DropDownList ID="ddlSerialPort" runat="server" PlaceHolder="Please select serial port" required="true" CssClass="form-control" Width="250px" Height="34px"></asp:DropDownList> 
                    </div>
                </div>
                  <div class="row">
                 ...
                 <div class="row">
                     <div class="col-md-2">Stop Bits:</div>
                    <div class="col-md-4">
                ...
                <div class="row">
                     <div class="col-md-2"></div>
                    <div class="col-md-4">
                        <asp:RadioButton ID="rbone" runat="server" group="type" text="1" required="true" Width="250px" Height="34px"></asp:RadioButton>
                    </div>
                    <div class="col-md-2"></div>
                    <div class="col-md-4">
                           <asp:RadioButton ID="rbone2" runat="server" group="type" text="1.5" required="true" Width="250px" Height="34px"></asp:RadioButton>
                    </div>
                ...
                <div class="row">
                     <div class="col-md-2"></div>
                    <div class="col-md-4">
                        <asp:RadioButton ID="rb2" runat="server" group="type" text="2" required="true" Width="250px" Height="34px"></asp:RadioButton>
                    </div>
                    <div class="col-md-2">	</div>
                    <div class="col-md-4">
                      ...
                      <div class="row">
                    <div class="col-md-2">Data Bits:</div>
                    <div class="col-md-4">
                         <asp:DropDownList ID="DropDownList2" runat="server" PlaceHolder="Please select rate" required="true" CssClass="form-control" Width="250px" Height="34px"></asp:DropDownList> 
                    </div>
                    <div class="col-md-2"></div>
                    <div class="col-md-4">
                    </div>
                 ...
                 <div class="row">
                    <div class="col-md-2">Hand Shaking:</div>
                    <div class="col-md-4">
                    </div>
                ...
                <div class="row">
                    <div class="col-md-2"></div>
                    <div class="col-md-4">
                           <asp:RadioButton ID="rbOn" Text="XOn/Off" group="type" runat="server" required="true"  Width="250px" Height="34px"></asp:RadioButton>
                    </div>
                    <div class="col-md-2"></div>
                    
                    <div class="col-md-4">
                        <asp:RadioButton ID="rbEven" runat="server" group="type" text="Even" required="true" />
                      <%--  <asp:RadioButton ID="rbEven" runat="server" group="type" text ="Even" required="true"  Width="250px" Height="34px"></asp:RadioButton>--%>
                ...
                <div class="row">
                     <div class="col-md-2"></div>
                    <div class="col-md-4">
                        <asp:RadioButton ID="rbNone" runat="server" group="type" text="None" required="true" Width="250px" Height="34px"></asp:RadioButton>
                    </div>
                    <div class="col-md-2"></div>
                    <div class="col-md-4">
                           <asp:RadioButton ID="RbOdd" runat="server" group="type" text="Odd" required="true" Width="250px" Height="34px"></asp:RadioButton>
                    </div>
                   ...
                   <div class="row">
                     <div class="col-md-2"></div>
                    <div class="col-md-4">
                        <asp:RadioButton ID="rbHardware" runat="server" text="Hardware"  />

                    </div>
                    <div class="col-md-2"></div>
                    <div class="col-md-4">
                           <asp:RadioButton ID="rbMark" runat="server" group="type" text ="Mark" required="true"  Width="250px" Height="34px"></asp:RadioButton>
                    </div>
                 ...
                 <div class="row">
                    ...
                    <div class="col-md-2"></div>
                    <div class="col-md-4">
                           <asp:RadioButton ID="rbSpace" text="Space" runat="server"  group="type" required="true" Width="250px" Height="34px"></asp:RadioButton>
                    </div>
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-2">ExtraData 4:</div>
                    <div class="col-md-4">
                        <asp:TextBox ID="txtExtraData4" runat="server" PlaceHolder="Please enter extradata "  required="true" CssClass="form-control" Width="250px" Height="34px"></asp:TextBox>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-2">ExtraData 5:</div>
                    <div class="col-md-4">
                        <asp:TextBox ID="txtExtraData5" runat="server" PlaceHolder="Please enter extradata" required="true" CssClass="form-control" Width="250px" Height="34px"></asp:TextBox>
                    </div>
                    <div class="col-md-2"></div>
                    <div class="col-md-4">
                 ...
                 <div class="row">
                    ...
                    <div class="col-md-4">
                        <asp:TextBox ID="txtDeviceLocation" runat="server" PlaceHolder="Please enter device location" required="true" CssClass="form-control" Width="250px" Height="34px"></asp:TextBox>
                    </div>
                    <div class="col-md-2">Device Site:</div>
                    <div class="col-md-4">
                        <asp:TextBox ID="DeviceSite" runat="server" PlaceHolder="Please enter device site" required="true" CssClass="form-control" Width="250px" Height="34px"></asp:TextBox>
                    </div>
                </div>
                 <div class="row">
               ...
               <div class="row">
                    ...
                    <div class="col-md-4">
                        <asp:FileUpload ID="fuNoResponse" runat="server" required="true" CssClass="form-control" Width="250px" Height="34px"></asp:FileUpload>
                    </div>
                 ...
                 <div class="row">
                    <div class="col-md-2">Last Day Read:</div>
                    <div class="col-md-4">
                        <asp:TextBox ID="txtLastDayRead" runat="server" PlaceHolder="Last Day Read" required="true" CssClass="form-control" Width="250px" Height="34px"></asp:TextBox>
                    </div>
            ...
            <div class="row">
                    ...
                    <div class="col-md-4">
                        <asp:TextBox ID="TextBox6" runat="server" PlaceHolder="Please enter  name" required="true" CssClass="form-control" Width="250px" Height="34px"></asp:TextBox>
                    </div>
