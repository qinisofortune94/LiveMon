<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"  CodeBehind="AddIPDevice.aspx.cs" Inherits="website2016V2.AddIPDevice" %>
        ...
        <div class="panel panel-default" style="width: 1080px">
            <div class="panel-heading" role="tab" id="headingOne">
                <h4 class="panel-title">
                    <a id="first" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="false" aria-controls="collapseOne"><strong>
                        <asp:Label ID="lblAdd" runat="server" Text="Add IP Device"></asp:Label>
                    </strong>
                    </a>
                </h4>
            </div>
                        ...
                        <div class="warning" id="warningMessage"  runat="server">
                               <asp:Label ID="lblWarning" runat="server"  Width="200px"></asp:Label>
                        </div>
                         <div class="warning" id="errorMessage"  runat="server">
            ...
            <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne" style="padding: 1%">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <asp:DropDownList ID="ddltype" runat="server" PlaceHolder="Please enter device type" required="true" CssClass="form-control" Width="250px" Height="34px" OnSelectedIndexChanged="ddltype_SelectedIndexChanged"></asp:DropDownList>
                    </div>
                    ...
                    <br />  
                 <div class="row">
                    <div class="col-md-2">Device Location:
                ...
                <div class="row">
                 ...
                 <br />
                  <div class="row">
                    <div class="col-md-2"><asp:Label ID="lblExtraData1" runat="server" Text="ExtraData 1:"></asp:Label>:</div>
                    <div class="col-md-4">
                     ...
                     <div class="col-md-2"><asp:Label ID="lblExtraData2" runat="server" Text="ExtraData 2:"></asp:Label>:</div>
                    <div class="col-md-4">
                 ...
                 <br />
                  <div class="row">
                      <div class="col-md-2"><asp:Label ID="lblExtraData3" runat="server" Text="ExtraData 3"></asp:Label>:</div>
                    <div class="col-md-4">
