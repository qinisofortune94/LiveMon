<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddAlert.aspx.cs" Inherits="website2016V2.AddAlert" %>

<asp:Content ID="Content1" ContentPlaceHolderID="pageContent" runat="server">
    <div class="">
                        <div class="page-title">
                                <div class="title_left">
                                    <h3>Add Alert Form</h3><br />
                                </div><br />
                                        ...
                                        <div class="ln_solid"></div>
                                         ...
                                         <div class="form-group">
                                            <div class="col-md-9 col-md-offset-4">
                                                <asp:Button ID="SubmitAlert" runat="server" CssClass="btn btn-success" Text="Save & Link Contacts" Width="160px" OnClick="SubmitAlert_Click"/>
                                            </div>
                                        </div>
