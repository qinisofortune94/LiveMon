<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ImportIPDevices.aspx.cs" Inherits="website2016V2.ImportIPDevices" %>
        ...
        <div class="panel panel-default" style="width: 100%">
            ...
            <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne" style="padding: 1%">
                 ...
                 <div class="row">
                    ...
                    <div class="col-md-4">
                        <asp:FileUpload ID="fuFile" runat="server" PlaceHolder="" required="true" CssClass="form-control" Width="250px" Height="34px"></asp:FileUpload>
                    </div>
                    <div class="col-md-2"></div>
                    <div class="col-md-4">
                         <asp:Button ID="btnLoad" runat="server" Text="Load" Width="120px" Height="40px" class="btn btn-success form-control" BorderColor="#0099FF" />
                    </div>
                </div>
                    <div class="row">
                    <div class="col-md-2">Number of rows:</div>
                    <div class="col-md-4">
                        <asp:TextBox ID="txtNumberORows" runat="server" PlaceHolder="Please enter  device location" required="true" CssClass="form-control" Width="250px" Height="34px"></asp:TextBox>
                    </div>
                    <div class="col-md-2"></div>
                    <div class="col-md-4">
                       <asp:Button ID="btnSubmit" runat="server" Text="Submit" Width="120px" Height="40px" class="btn btn-success form-control" BorderColor="#0099FF"/>
                    </div>
                <br />
