...
{
    public partial class AddOtherDevices : System.Web.UI.Page
    {
        ...
        protected void btnAdd_Click(object sender, System.EventArgs e)
        {
           ...
           // NewIPDevice.Type =LiveMonitoring.IRemoteLib.OtherDevicesDetails.DeviceType)Convert.ToInt32 (this.ddltype.SelectedValue);
        ...
        //   NewIPDevice.IPAdress = this.txtIP1.Value.ToString + "." + this.txtIP2.Value.ToString + "." + this.txtIP3.Value.ToString + "." + this.txtIP4.Value.ToString;
         //   if (double.IsNaN(this.txtPort.Text) == false)
            ...
            try
            {
                ...
                NewIPDevice.Add2Site = Convert.ToInt32(ddlDevice.SelectedValue);
                //End If
            ...
            bool Myresp = MyRem.LiveMonServer.AddNewOtherDevice(NewIPDevice);
            if (Myresp)
            {
                //save fields
                //whoopeee
                try
                {
                    ...
                    MyRem.WriteLog("Add OtherDevice Succeeded", "User:" + MyUser.ID.ToString() + "|" + Myresp.ToString());
                ...
                try
                {
                    ...
                    {
                        MyRem.LiveMonServer.AddEditLocationLink(NewIPDevice.ID, Convert.ToInt32(ddlDeviceLocation.SelectedValue), LiveMonitoring.IRemoteLib.LocationDetails.DeviceSensorType.Other_Device, -99);
                    }
            ...
            else
            {
                ...
                try
                {
                    MyRem.WriteLog("Add OtherDevice Failed", "User:" + MyUser.ID.ToString() + "|" + this.txtCaption.Text);
