<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CumulativeDisplayGraph.aspx.cs" Inherits="website2016V2.CumulativeDisplayGraph" %>
            ...
            <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne" style="padding: 1%">
                ...
                <div class="row">
                 ...
                 <div class="row">
                     ...
                     <div class="col-md-4">
                           <asp:DropDownList ID="ddlMeters" runat="server"  required="true" CssClass="form-control" Width="250px" Height="34px">
                        </asp:DropDownList>
                     </div>
