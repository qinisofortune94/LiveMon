...
{
    public partial class ManageMeteringTarriffs : System.Web.UI.Page
    {
        ...
        protected void gridPeriod_PageIndexChanging(object sender, GridViewPageEventArgs e)
        {
            gridPeriod.PageIndex = e.NewPageIndex;
        ...
        protected void gvSample_Commands(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (commandName == "SelectItem")
            {
                ...
                LoadPeriods(Convert.ToInt32(ViewState["Id"]));
                accordionPeriod.Visible = true;
                accordionTT.Visible = true;
        ...
        public void MeteringManageTerrif()
        {
            Load += Page_Load;
        }
