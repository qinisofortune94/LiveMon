<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PowerStatusUserControl.ascx.cs" Inherits="website2016V2.Usercontrols.PowerStatusUserControl" %>
...
<asp:UpdatePanel ID="MeterInfoUpdatePanel" runat="server">
    <ContentTemplate>
        <asp:Table ID="Table1" runat="server">
            ...
            <asp:TableRow>
                <asp:TableCell>KVA</asp:TableCell><asp:TableCell>
                    <asp:TextBox ID="txtKVA" runat="server" CssClass="form-control" Width="250px" Height="34px">0 KVA</asp:TextBox></asp:TableCell><asp:TableCell>
                        <asp:TextBox ID="txtAvgKVA" runat="server" CssClass="form-control" Width="250px" Height="34px">0 KVA</asp:TextBox></asp:TableCell><asp:TableCell>
                            <asp:TextBox ID="txtHistKVA" runat="server" CssClass="form-control" Width="250px" Height="34px">0 KVA</asp:TextBox></asp:TableCell></asp:TableRow>
            <asp:TableRow>
                <asp:TableCell>KVar</asp:TableCell><asp:TableCell>
                    <asp:TextBox ID="txtKVar" runat="server" CssClass="form-control" Width="250px" Height="34px">0 KVar</asp:TextBox></asp:TableCell><asp:TableCell>
                        <asp:TextBox ID="txtAvgKVar" runat="server" CssClass="form-control" Width="250px" Height="34px">0 KVar</asp:TextBox></asp:TableCell><asp:TableCell>
                            <asp:TextBox ID="txtHistKVar" runat="server" CssClass="form-control" Width="250px" Height="34px">0 KVar</asp:TextBox></asp:TableCell></asp:TableRow>
            <asp:TableRow>
                <asp:TableCell>pf</asp:TableCell><asp:TableCell>
                    <asp:TextBox ID="txtpf" runat="server" CssClass="form-control" Width="250px" Height="34px">0 pf</asp:TextBox></asp:TableCell><asp:TableCell>
                        <asp:TextBox ID="txtAvgpf" runat="server" CssClass="form-control" Width="250px" Height="34px">0 pf</asp:TextBox></asp:TableCell><asp:TableCell>
                            <asp:TextBox ID="txtHistpf" runat="server" CssClass="form-control" Width="250px" Height="34px">0 pf</asp:TextBox></asp:TableCell></asp:TableRow>
        </asp:Table>
