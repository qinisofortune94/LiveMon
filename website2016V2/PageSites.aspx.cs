    ...
    public partial class PageSites : System.Web.UI.Page
    {
        ...
        protected void gvSample_Commands(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (commandName == "EditItem")
            {
                ...
                try
                {
                    txtSite.Text = gridSites.Rows[myRow.RowIndex].Cells[3].Text; ;
                    try
                    {
            ...
            else if (commandName == "DeleteItem")
            {
                ...
                try
                {
                    ...
                    MyDataAccess.ExecCmdQueryParams("sp_deleteSpecificSite", myParams);
        ...
        public bool CanSave()
        {
            ...
            {
                errorMessage.Visible = true;
                lblError.Text = "Please enter site name.";
                txtSite.Focus();
                return false;
            }
        ...
        protected void btnSave_Click(object sender, EventArgs e)
        {
            if (CanSave())
            {
                ...
                if (temp.Contains("Add"))
                {
                    ...
                    {
                        errorMessage.Visible = true;
                        lblError.Text = "An error occured while trying to save site, please try again.";
                    }
                }
