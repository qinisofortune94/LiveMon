<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="IPBulkDevices.aspx.cs" Inherits="website2016V2.IPDevices.IPBulkDevices" %>
    ...
    <div id="accordion" role="tablist" aria-multiselectable="true">
        <div class="panel panel-default" style="width: 100%">
            ...
            <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne" style="padding: 1%">
                <div class="row">
                    <div class="col-md-2">Number of IP Devices:</div>
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        <asp:CheckBox ID="chkDeviceNumber" runat="server" required="true" Width="250px" Height="34px"></asp:CheckBox>
                    </div>
                </div>
                   <div class="row">
                    <div class="col-md-2">Import File:</div>
                    <div class="col-md-4">
                        <asp:FileUpload ID="fuImport" runat="server" required="true" CssClass="form-control" Width="250px" Height="34px"></asp:FileUpload>
                    </div>
