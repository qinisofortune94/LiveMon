<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SLServerDisplayOOB.aspx.cs" Inherits="website2016V2.SLServerDisplayOOB" %>
            ...
            <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne" style="padding: 1%">
                <div class="row">
                    ...
                    <div id="silverlightObjDiv" ClientIDMode="Static" style="width: 100%;height:800px;">
                        <asp:Silverlight ID="Xaml1" runat="server" MinimumVersion="2.0.31005.0" Width="49%" Height="64%" />
                    </div>
