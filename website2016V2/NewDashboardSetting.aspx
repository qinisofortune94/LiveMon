                                            ...
                                            <div id="gr" runat="server" class="form-group">
                                                <div class="col-md-4 col-sm-6 col-xs-6">
                                                    <asp:GridView ID="gridDashboards" runat="server"
                                                        CellPadding="4" ForeColor="#333333" CssClass="gvdatatable table table-striped table-bordered" OnSelectedIndexChanged="gridDashboards_SelectedIndexChanged" Width="100%" AllowPaging="True" PageSize="3" AutoGenerateColumns="False">
