<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ProfileDisplay.aspx.cs" Inherits="website2016V2.ProfileDisplay" %>
...
.ui-timepicker-div td { font-size: 90%; }
        ...
        <div class="panel panel-default" style="width: 100%">
            ...
            <%--    <div class="row">
                ...
                <div class="row">
                  ...
                  <br />
                 <div class="row">
                     <div class="col-md-2">Tree View</div>
                    <div class="col-md-4">
                        <asp:TreeView ID="tvSensors" runat="server"> </asp:TreeView>
                    </div>
                    <div class="col-md-2">
                    </div>
                    <div class="col-md-4">
                        <asp:Button ID="btnGenerate1" runat="server" Text="Generate" Width="250px" class="btn btn-success form-control" BorderColor="#0099FF" height="40px" OnClick="btnGenerate1_Click1" />
                    </div>
                     </div>
                    </asp:Panel>
                <br />
  ...
  <div class="row">
     ...
     <div class="row">
                    ...
                    <div class="col-md-2"></div>
                    <div class="col-md-4">
                       <div  ID="Div2" runat="server" enableviewstate="true">
                    </div>
                    </div>
             <div class="col-md-2"></div>
                    <div class="col-md-4">
                          <div ID="Div3" runat="server" enableviewstate="true"></div>
                    </div>
             </div>
        </div>
</asp:Content>
