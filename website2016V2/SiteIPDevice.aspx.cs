...
{
    public partial class SiteIPDevice : System.Web.UI.Page
    {
        ...
        protected void gvSample_Commands(object sender, GridViewCommandEventArgs e)
        {
            ...
            if (commandName == "EditItem")
            {
                ...
                drpSite.SelectedItem.Text = gridDevices.Rows[myRow.RowIndex].Cells[3].Text;
                drpDevices.SelectedItem.Text = gridDevices.Rows[myRow.RowIndex].Cells[4].Text;
            ...
            else if (commandName == "DeleteItem")
            {
                ...
                try
                {
                    ...
                    MyDataAccess.ExecCmdQueryParams("sp_deleteIPDEvices", myParams);
                    LoadDevices(Convert.ToInt32(drpViewSite.SelectedValue));
                }
                catch (Exception ex)
                {
        ...
        {
            string sqlQuery = "[Sites].[spGetAllIPDevices]";
        ...
        {
            string sqlQuery = "[Sites].[spGetIPDevices]";
            SqlConnection connection = new SqlConnection(conStr);
        ...
        public bool SaveSiteDevices()
        {
            ...
            try
            {
                ...
                cmd.CommandText = "[Sites].[spAddIPDevices]";
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Connection = con;
        ...
        public bool EditSiteDevices(int id)
        {
            ...
            try
            {
                ...
                cmd.CommandText = "[Sites].[spEditIPDevices]";
                cmd.CommandType = CommandType.StoredProcedure;
                cmd.Connection = con;
                cmd.Parameters.Clear();
            ...
            if (temp.Contains("Add"))
            {
                ...
                if (canSave() == true)
                {
                    if (SaveSiteDevices() == true)
                    {
                        ...
                        lblSuccess.Text = "Site Device successfully saved!";
            ...
            else if (temp.Contains("Update"))
            {
                ...
                try
                {
                    ...
                    if (canSave() == true)
                    {
                        ...
                        {
                            successMessage.Visible = true;
                            lblSuccess.Text = "Site Device successfully updated!";
                            //Edit.Visible = false;
                            drpSite.SelectedIndex = -1;
                            drpDevices.SelectedIndex = -1;
                            LoadDevices(Convert.ToInt32(drpViewSite.SelectedValue));
