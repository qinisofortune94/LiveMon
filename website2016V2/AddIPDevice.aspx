...
<asp:Content ID="Content1" ContentPlaceHolderID="pageContent" runat="server">
    ...
    <div class="card" style="font-size: 13px">
        <div class="card-header">
            <h3 class="card-title">Add IP Device
            </h3>
        ...
        <div class="card-body" style="display: block;">
            <div class="row">
                ...
                <div class="col-sm-4">
                    <div class="form-group">
                        Device Location
                        <asp:DropDownList ID="ddlDeviceLocation" runat="server" AutoPostBack="true" PlaceHolder="" required="true" CssClass="form-control">
                        </asp:DropDownList>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-4">
                    ...
                    <div class="form-group">
                        Device Site
                        <asp:DropDownList ID="ddlDevice" runat="server" AutoPostBack="true" PlaceHolder="" required="true" CssClass="form-control">
                        </asp:DropDownList>
                    </div>
                </div>
