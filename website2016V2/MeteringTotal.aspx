<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MeteringTotal.aspx.cs" Inherits="website2016V2.Metering.MeteringTotal" %>
        ...
        <div class="panel panel-default" style="width: 100%">
            <div class="panel-heading" role="tab" id="headingOne">
                <h4 class="panel-title">
                    <a id="first" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="false" aria-controls="collapseOne"><strong>
                        <asp:Label ID="lblAdd" runat="server" Text="TOU Total : Select Range Dates OR Default Range"></asp:Label>
            ...
            <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne" style="padding: 1%">
                ...
                <br />
                    ...
                    <div class="col-md-4">
                        <asp:Button ID="btnGenerate2" runat="server" Text="Generate" Width="250px" class="btn btn-success form-control" height ="40px" BorderColor="#0099FF" OnClick="btnGenerate2_Click" />
                    </div>
                               </div>
                         </asp:Panel>
