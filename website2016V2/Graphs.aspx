<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Graphs.aspx.cs" Inherits="website2016V2.Graphs" %>

<%@ Register TagPrefix="igchart" Namespace="Infragistics.UltraChart.Resources.Appearance" Assembly="Infragistics2.WebUI.UltraWebChart.v7.1, Version=7.1.20071.1071, Culture=neutral, PublicKeyToken=7dd5c3163f2cd0cb" %>
...
<%@ Register Src="MeteringPhasorDiagram.ascx" TagName="MeteringPhasorDiagram" TagPrefix="uc1" %>
...
.ui-timepicker-div td { font-size: 90%; }
        ...
        <div class="panel panel-default" style="width: 100%">
            ...
            <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne" style="padding: 1%">
                ...
                <div class="col-md-2">Filter By Sensor:</div>
                            <div class="col-md-4">
                                <asp:TextBox ID="txtSensorName" runat="server" PlaceHolder="Filter by sensor" required="true" CssClass="form-control" Width="250px" Height="34px"></asp:TextBox>
    ...
    <script type="text/javascript">
        ...
        Calendar.setup(
            {
                inputField: "startrange", // ID of the input field
        ...
        Calendar.setup(
            {
                inputField: "endrange", // ID of the input field
