<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddCameras.aspx.cs" Inherits="website2016V2.AddCameras" %>
...
<div class="card" style="font-size:13px" id="accordion">
    <div class="card-header">
          <h3 class="card-title">Add Cameras</h3>
...
<div class="card-body">
            <div class="row">
                    <div class="col-sm-4">
                      <div class="form-group">
                        IP Address
                        <asp:TextBox ID="txtIpAdrres" runat="server" PlaceHolder="Please enter IP address" required="true" CssClass="form-control"></asp:TextBox>
                      </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                      <div class="form-group">
                         Port
                        <asp:TextBox ID="txtPort" runat="server" PlaceHolder="Please enter port number" required="true" CssClass="form-control"></asp:TextBox>
                      </div>
                    </div>
                 ...
                 <div class="col-sm-4">
                      <div class="form-group">
                       Username
                        <asp:TextBox ID="txtUserName" runat="server" PlaceHolder="Please enter username" required="true" CssClass="form-control"></asp:TextBox>
                      </div>
                    </div>
                  </div>
            ...
            <div class="row">
                    <div class="col-sm-4">
                      <div class="form-group">
                        Password
                        <asp:TextBox ID="txtPassword" runat="server" PlaceHolder="Please enter password" required="true" CssClass="form-control"></asp:TextBox>
                      </div>
                    </div>
                    ...
                    <div class="col-sm-4">
                      <div class="form-group">
                        Caption
                        <asp:TextBox ID="TxtCapiton" runat="server" PlaceHolder="Please enter caption" required="true" CssClass="form-control"></asp:TextBox>
                      </div>
                    </div>
            ...
            <br />
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="form-group"><asp:FileUpload ID="filImageError" runat="server" />
