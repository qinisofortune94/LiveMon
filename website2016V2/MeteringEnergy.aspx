<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MeteringEnergy.aspx.cs" Inherits="website2016V2.Metering.MeteringEnergy" %>
...
.ui-timepicker-div td { font-size: 90%; }
    ...
    <div id="accordion" role="tablist" aria-multiselectable="true">
        <div class="panel panel-default" style="width: 100%">
            <div class="panel-heading" role="tab" id="headingOne">
                <h4 class="panel-title">
                    <a id="first" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="false" aria-controls="collapseOne"><strong>
                        <asp:Label ID="lblAdd" runat="server" Text="Energy : Select Range Dates OR Default Range"></asp:Label>
            ...
            <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne" style="padding: 1%">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <asp:DropDownList ID="ddlMeters" runat="server"  required="true" CssClass="form-control" Width="250px" Height="34px"></asp:DropDownList>
                    </div>
                </div>
                ...
                <div class="row">
                 ...
                 <div class="row">
                    ...
                    <div class="col-md-4">
                        <asp:Button ID="btnGenerate1" runat="server" height="40px" Text="Generate" Width="250px" class="btn btn-success form-control" BorderColor="#0099FF" OnClick="btnGenerate1_Click1" />
                    </div>
                     </div>
                    </asp:Panel>
                <br />
                    ...
                    <div class="col-md-4">
                        <asp:Button ID="btnGenerate2" runat="server" height="40px" Text="Generate" Width="250px" class="btn btn-success form-control" BorderColor="#0099FF" OnClick="btnGenerate2_Click" />
                    </div>
                               </div>
                         </asp:Panel>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <asp:DropDownList ID="ddlTarrif" runat="server" PlaceHolder="Please enter date of birth" required="true" CssClass="form-control" Width="250px" Height="34px" OnSelectedIndexChanged="ddlTarrif_SelectedIndexChanged"></asp:DropDownList>
                    </div>
                </div>
               ...
               <%--<div class="row">
                  ...
                  <%--  <div class="col-md-4">
                        <asp:Button ID="BtnClear" runat="server" Text="Clear" Width="250px" class="btn btn-primary form-control" BorderColor="#0099FF" height ="40px" OnClick="BtnClear_Click"/>
                    </div>
       ...
       <div class="panel panel-default" style="width: 100%">
                 ...
                 <div class="row">
                    <div class="col-md-12" >
                          <div  ID="Charts" runat="server" enableviewstate="true" style="overflow: scroll" class="div">
                    </div>
                    </div>
                 </div>
            <div class="row">
                    <div class="col-md-12">
                       <div  ID="DivTarrifReport" runat="server" enableviewstate="true" style="overflow: scroll" class="div">
                    </div>
                         </div>
                </div>
                  <br />
         <div class="row">
                    <div class="col-md-12">
                          <div ID="Graph" runat="server" enableviewstate="true" style="overflow: scroll" class="div"></div>
                    </div>
             </div>
            <div class="row">
                    <div class="col-md-12">
                       <div  ID="DivKvarStatsReport" runat="server" enableviewstate="true" style="overflow: scroll" class="div">
                    </div>
                    </div> 
                </div>  
        <br />
           ...
           <div class="row">
                    <div class="col-md-12">
                          <div  ID="DivKvarReport" runat="server" enableviewstate="true" style="overflow: scroll" class="div">
                    </div>
                    </div>
               </div>
             <div class="row">
                    <div class="col-md-12">
                          <div ID="Div3" runat="server" enableviewstate="true" style="overflow: scroll" class="div"></div>
                    </div>
                </div>
             </div>
