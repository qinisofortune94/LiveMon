...
namespace website2016V2
{
    ...
    public partial class MeteringTOUMonthly : System.Web.UI.Page
    {
        ...
        public void AddTOUReport(LiveMonitoring.IRemoteLib.SensorDetails SensorDet)
        {
            ...
            List<LiveMonitoring.IRemoteLib.SummaryTOURecord> MySummaryData = null;
            ...
            {
                MySummaryData = GenerateSummaryData(SensorDet, MyData, MyDataMarkers, MyTarrif);
                switch (SensorDet.Type)
                {
                    case LiveMonitoring.IRemoteLib.SensorDetails.SensorType.ElsterA1140MeterReadProfile:
                        ...
                        //DrawElsterTotalA1700StatsReport(SensorDet, MySummaryData, MyDataMarkers, MyTarrif);
                        //DrawElsterTotalA1700TOUReport(SensorDet, MySummaryData, MyDataMarkers, MyTarrif);
                    ...
                    case LiveMonitoring.IRemoteLib.SensorDetails.SensorType.LandisGyrE650Profile:
                        DrawLandisTotalStatsReport(SensorDet, MySummaryData, MyDataMarkers, MyTarrif);
                        DrawLandisTotalTOUReport(SensorDet, MySummaryData, MyDataMarkers, MyTarrif);
                        break;
                    ...
                    switch (Convert.ToInt32(this.ddlTotal.SelectedValue))
                    {
                        case 0:
                            if (DateAndTime.DateDiff(DateInterval.Minute, starttime, MyDataHistory.TimeStamp) >= 30)
                            {
                                try
                                {
                                    retList.Add(AppendSummaryData(starttime, "0.5", Convert.ToInt32(MyPeriod), TotKWhCnt, PeakKWhCnt, StandKWhCnt, OffPeakKWhCnt));
                                    PeakKWhCnt = 0;
                                    OffPeakKWhCnt = 0;
                                    StandKWhCnt = 0;
                                    TotKWhCnt = 0;
                        ...
                        case 1:
                            ...
                            if (DateAndTime.DateDiff(DateInterval.Minute, starttime, MyDataHistory.TimeStamp) >= 60)
                            {
                                try
                                {
                                    retList.Add(AppendSummaryData(starttime, "1", Convert.ToInt32(MyPeriod), TotKWhCnt, PeakKWhCnt, StandKWhCnt, OffPeakKWhCnt));
                                    PeakKWhCnt = 0;
                                    OffPeakKWhCnt = 0;
                                    StandKWhCnt = 0;
                                    TotKWhCnt = 0;
                        ...
                        case 2:
                            ...
                            if (DateAndTime.DateDiff(DateInterval.Minute, starttime, MyDataHistory.TimeStamp) >= 120)
                            {
                                try
                                {
                                    retList.Add(AppendSummaryData(starttime, "2", Convert.ToInt32(MyPeriod), TotKWhCnt, PeakKWhCnt, StandKWhCnt, OffPeakKWhCnt));
                                    PeakKWhCnt = 0;
                                    OffPeakKWhCnt = 0;
                                    StandKWhCnt = 0;
                                    TotKWhCnt = 0;
                        ...
                        case 3:
                            if (DateAndTime.DateDiff(DateInterval.Minute, starttime, MyDataHistory.TimeStamp) >= 180)
                            {
                                try
                                {
                                    retList.Add(AppendSummaryData(starttime, "3", Convert.ToInt32(MyPeriod), TotKWhCnt, PeakKWhCnt, StandKWhCnt, OffPeakKWhCnt));
                                    PeakKWhCnt = 0;
                                    OffPeakKWhCnt = 0;
                                    StandKWhCnt = 0;
                                    TotKWhCnt = 0;
                        ...
                        case 4:
                            if (DateAndTime.DateDiff(DateInterval.Minute, starttime, MyDataHistory.TimeStamp) >= 300)
                            {
                                try
                                {
                                    retList.Add(AppendSummaryData(starttime, "5", Convert.ToInt32(MyPeriod), TotKWhCnt, PeakKWhCnt, StandKWhCnt, OffPeakKWhCnt));
                                    PeakKWhCnt = 0;
                                    OffPeakKWhCnt = 0;
                                    StandKWhCnt = 0;
                                    TotKWhCnt = 0;
                        ...
                        case 5:
                            ...
                            if (DateAndTime.DateDiff(DateInterval.Minute, starttime, MyDataHistory.TimeStamp) >= 600)
                            {
                                try
                                {
                                    retList.Add(AppendSummaryData(starttime, "10", Convert.ToInt32(MyPeriod), TotKWhCnt, PeakKWhCnt, StandKWhCnt, OffPeakKWhCnt));
                                    PeakKWhCnt = 0;
                                    OffPeakKWhCnt = 0;
                                    StandKWhCnt = 0;
                                    TotKWhCnt = 0;
                        ...
                        case 6:
                            ...
                            if (DateAndTime.DateDiff(DateInterval.Minute, starttime, MyDataHistory.TimeStamp) >= 720)
                            {
                                try
                                {
                                    retList.Add(AppendSummaryData(starttime, "12", Convert.ToInt32(MyPeriod), TotKWhCnt, PeakKWhCnt, StandKWhCnt, OffPeakKWhCnt));
                                    PeakKWhCnt = 0;
                                    OffPeakKWhCnt = 0;
                                    StandKWhCnt = 0;
                                    TotKWhCnt = 0;
                        ...
                        case 7:
                            ...
                            if (DateAndTime.DateDiff(DateInterval.Minute, starttime, MyDataHistory.TimeStamp) >= 1440)
                            {
                                try
                                {
                                    retList.Add(AppendSummaryData(starttime, "24", Convert.ToInt32(MyPeriod), TotKWhCnt, PeakKWhCnt, StandKWhCnt, OffPeakKWhCnt));
                                    PeakKWhCnt = 0;
                                    OffPeakKWhCnt = 0;
                                    StandKWhCnt = 0;
                                    TotKWhCnt = 0;
                        ...
                        case 8:
                            if (DateAndTime.DateDiff(DateInterval.Minute, starttime, MyDataHistory.TimeStamp) >= 2880)
                            {
                                try
                                {
                                    retList.Add(AppendSummaryData(starttime, "2 Days", Convert.ToInt32(MyPeriod), TotKWhCnt, PeakKWhCnt, StandKWhCnt, OffPeakKWhCnt));
                                    PeakKWhCnt = 0;
                                    OffPeakKWhCnt = 0;
                                    StandKWhCnt = 0;
                                    TotKWhCnt = 0;
                        ...
                        case 9:
                            ...
                            if (DateAndTime.DateDiff(DateInterval.Minute, starttime, MyDataHistory.TimeStamp) >= 5760)
                            {
                                try
                                {
                                    retList.Add(AppendSummaryData(starttime, "4 Days", Convert.ToInt32(MyPeriod), TotKWhCnt, PeakKWhCnt, StandKWhCnt, OffPeakKWhCnt));
                                    PeakKWhCnt = 0;
                                    OffPeakKWhCnt = 0;
                                    StandKWhCnt = 0;
                                    TotKWhCnt = 0;
                        ...
                        case 10:
                            ...
                            if (DateAndTime.DateDiff(DateInterval.Day, starttime, MyDataHistory.TimeStamp) >= 7)
                            {
                                try
                                {
                                    retList.Add(AppendSummaryData(starttime, "7 Days", Convert.ToInt32(MyPeriod), TotKWhCnt, PeakKWhCnt, StandKWhCnt, OffPeakKWhCnt));
                                    PeakKWhCnt = 0;
                                    OffPeakKWhCnt = 0;
                                    StandKWhCnt = 0;
                                    TotKWhCnt = 0;
                        ...
                        case 11:
                            ...
                            if (starttime.Month != MyDataHistory.TimeStamp.Month)
                            {
                                try
                                {
                                    retList.Add(AppendSummaryData(starttime, "Month", Convert.ToInt32(MyPeriod), TotKWhCnt, PeakKWhCnt, StandKWhCnt, OffPeakKWhCnt));
                                    PeakKWhCnt = 0;
                                    OffPeakKWhCnt = 0;
                                    StandKWhCnt = 0;
                                    TotKWhCnt = 0;
        ...
        public void DrawElsterTotalA1700StatsReport(LiveMonitoring.IRemoteLib.SensorDetails SensorDet, List<LiveMonitoring.IRemoteLib.SummaryTOURecord> MyData, List<LiveMonitoring.IRemoteLib.MeteringProfileMarker> MyDataMarkers, LiveMonitoring.IRemoteLib.MeteringTarrifDetails MyTarrif)
        {
            try
            {
               ...
               // List<LiveMonitoring.IRemoteLib.SummaryTOURecord> MyDataHistory;
                ...
                foreach (LiveMonitoring.IRemoteLib.SummaryTOURecord MyDataHistory_loopVariable in MyData)
                {
                   // MyDataHistory = MyDataHistory_loopVariable;
                    ...
                    MyHtmlStr.Append(AppendData(MyDataHistory_loopVariable.TimeStamp, MyDataHistory_loopVariable.SummaryInterval, MyDataHistory_loopVariable.MeteringInterval, MyDataHistory_loopVariable.Total_KWh, MyDataHistory_loopVariable.Peak_KWh, MyDataHistory_loopVariable.Std_KWh, MyDataHistory_loopVariable.Off_KWh));
        ...
        public void DrawLandisTotalStatsReport(LiveMonitoring.IRemoteLib.SensorDetails SensorDet, List<LiveMonitoring.IRemoteLib.SummaryTOURecord> MyData, List<LiveMonitoring.IRemoteLib.MeteringProfileMarker> MyDataMarkers, LiveMonitoring.IRemoteLib.MeteringTarrifDetails MyTarrif)
        {
            try
            {
                StringBuilder MyHtmlStr = new StringBuilder();
        ...
        public void DrawLandisTotalTOUReport(LiveMonitoring.IRemoteLib.SensorDetails SensorDet, List<LiveMonitoring.IRemoteLib.SummaryTOURecord> MyData, List<LiveMonitoring.IRemoteLib.MeteringProfileMarker> MyDataMarkers, LiveMonitoring.IRemoteLib.MeteringTarrifDetails MyTarrif)
        {
            //attach event for legent width
            MyDateLinechart1.EnableCrossHair = false;
        ...
        public void DrawLandisGyrE650Profile2(LiveMonitoring.IRemoteLib.SensorDetails SensorDet, List<LiveMonitoring.IRemoteLib.MeteringProfileRecord> MyData, List<LiveMonitoring.IRemoteLib.MeteringProfileMarker> MyDataMarkers)
        {
            ...
            MyDateLinechart1.ChartDrawItem += ultraChart1_ChartDrawItem;
            MyDateLinechart1.ID = "LandisGyrE650" + SensorDet.ID.ToString();
            MyDateLinechart1.TitleTop.Extent = 45;
            //sets the font color
            MyDateLinechart1.TitleTop.FontColor = Color.Red;
            //sets whether the chart auto-sizes the font for the title
