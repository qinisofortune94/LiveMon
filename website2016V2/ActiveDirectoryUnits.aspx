            ...
            <div class="panel-heading" role="tab" id="headingTwo">
                <div class="row">
                    ...
                    <div class="col-md-4 right">
                        <asp:DropDownList ID="drpMainSites" AutoPostBack="true" runat="server" OnSelectedIndexChanged="drpMainSites_SelectedIndexChanged" required="true" CssClass="form-control" Width="250px" Height="34px"></asp:DropDownList>
                    </div>
                </div>
