<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AlertHistory.aspx.cs" Inherits="website2016V2.AlertHistory" %>
            ...
            <div class="panel-heading" role="tab" id="headingOne">
                <h4 class="panel-title">
                    <a id="first" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="false" aria-controls="collapseOne"><strong>
                        <asp:Label ID="lblAdd" runat="server" Text="Alert History"></asp:Label>
                    </strong>
                    </a>
                </h4>
            </div>
        ...
        <div class="panel panel-default" style="width: 100%">
            ...
            <div id="collapseTwo" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingTwo" style="padding: 1%"> 
                <div class="row">
                    ...
                    <div class="col-md-12">
                     <asp:GridView ID="GridAlertHistory" runat="server"  CssClass="gvdatatable table table-striped table-bordered" AllowPaging="True" AllowSorting="True" CellPadding="4" ForeColor="#333333" GridLines="None"  Width="100%" OnPageIndexChanging="Usergrid_PageIndexChanging">
