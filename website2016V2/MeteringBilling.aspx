<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MeteringBilling.aspx.cs" Inherits="website2016V2.Metering.MeteringBilling" %>
                                    ...
                                    <div class="col-md-12 pull-right">
                                        <div class="col-md-2 pull-right">
                                            <div class="form-group">
                                                <asp:DropDownList ID="cmbCurrentSite" runat="server" CssClass="pull-right form-control btn-round" AutoPostBack="true" Visible="false" ToolTip="Select Site to view ." >
                                                </asp:DropDownList>
                                            </div>    
                                        </div>
            ...
            <div class="panel-heading" role="tab" id="headingOne">
                <h4 class="panel-title">
                    <a id="first" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="false" aria-controls="collapseOne"><strong>
                        <asp:Label ID="lblAdd" runat="server" Text="Billing : Select Range Dates OR Default Range"></asp:Label>
            ...
            <div id="collapseOne" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne" style="padding: 1%">  
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        ...
                        <asp:TextBox ID="txtStart" runat="server"  CssClass="form-control" Width="250px" Height="34px">           
                   ...
                   <div class="col-md-2">End Day:</div>
                    <div class="col-md-4">
                          <span ID="SpanTimePicker">
                        <asp:TextBox ID="txtEnd" runat="server"   CssClass="form-control" Width="250px" Height="34px"></asp:TextBox>
              </span>
                         </div>
                 ...
                 <div class="row">
                    ...
                    <div class="col-md-4">
                        <asp:Button ID="btnGenerate1" runat="server" Text="Generate" Width="250px" class="btn btn-success form-control" BorderColor="#0099FF" OnClick="btnGenerate1_Click1" height="40px"/>
                    </div>
                     </div>
                    </asp:Panel>
                <br />
                    ...
                    <div class="col-md-4">
                        <asp:Button ID="btnGenerate2" runat="server" Text="Generate" Width="250px" class="btn btn-success form-control" BorderColor="#0099FF" OnClick="btnGenerate2_Click" height="40px"/>
                    </div>
                               </div>
                         </asp:Panel>
               ...
               <div class="row">
                   ...
                   <%-- <div class="col-md-4">
                        <asp:Button ID="BtnClear" runat="server" Text="Clear" Width="250px" class="btn btn-primary form-control" BorderColor="#0099FF" height ="40px"/>
                    </div>
              --%>
...
<%--    <script type="text/javascript">
   ...
   Calendar.setup(
	{
	    inputField: "txtStart", // ID of the input field
    		    ...
    		    Calendar.setup(
	{
     ...
     <%--<div class="row">
                    ...
                    <div class="col-md-4">
                          <div  ID="Charts" runat="server"  style="overflow: scroll" enableviewstate="true">
                    </div>
                    </div>
         </div>--%>
                 <div class="row"> 
