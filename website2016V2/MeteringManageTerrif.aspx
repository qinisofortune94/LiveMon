<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="MeteringManageTerrif.aspx.cs" Inherits="website2016V2.MeteringManageTerrif" %>
                ...
                <div class="row">
                    <div class="col-md-12">
                       <asp:Label ID="sss" runat="server"></asp:Label>
                        <asp:GridView ID="gridPeriod" CssClass="gvdatatable table table-striped table-bordered" runat="server" AutoGenerateColumns="false">

                            <Columns>
                                <asp:BoundField DataField="ChargeName" HeaderText="ChargeName" SortExpression="ChargeName"/>
                                <asp:BoundField DataField="StartTime" HeaderText="StartTime" SortExpression="StartTime"/>
                                <asp:BoundField DataField="EndTime" HeaderText="EndTime" />
                                <asp:BoundField DataField="ChargeDay" HeaderText="ChargeDay" />
