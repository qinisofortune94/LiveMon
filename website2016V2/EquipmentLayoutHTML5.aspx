<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="EquipmentLayoutHTML5.aspx.cs" Inherits="website2016V2.EquipmentLayoutHTML5" %>
          ...
          toolTip:  //??
            $(go.Adornment, "Auto",
              ...
              $(go.TextBlock, { margin: 4 },  // the tooltip shows the result of calling nodeInfo(data)
                new go.Binding("text", "", function(a) {
                  return a.adornedPart._treeParentNode + "\n" + a.adornedPart.findTreeParentNode();
                }).ofObject()))
        },
...
<body onload="init()">
<div id="sample" style="margin-top:100px">
...
{ "class": "go.GraphLinksModel",
  "nodeDataArray": [
{"key":"1", "name":"Khulile 'The Great' Dunga", "title":"The Boss"},
