...
{
    public partial class SLDeviceDisplayPage : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (((string)Session["LoggedIn"] == "True"))
            {
                ...
                // user = this.Master.FindControl("lblUser") as Label;
               ...
               // Label LastLogin = this.Master.FindControl("LastLogin") as Label;
                ...
                this.Xaml1.Source = "~/ClientBin/SLDeviceDisplay.xap";
                if (!string.IsNullOrEmpty(Request.QueryString["DisplayID"]))
                {
                    ...
                    {
                        this.Xaml1.InitParameters = "DisplayID=" + Convert.ToString(Request.QueryString["DisplayID"]) + ",ServiceRef=" + MyRef + ",PmaxServiceRef=" + MyPmaxRef + ",UserName=" + MyUser.UserName + ",Password=" + MyUser.Password;
                    }
                    else
                    {
                        this.Xaml1.InitParameters = "DisplayID=" + Convert.ToString(Request.QueryString["DisplayID"]) + ",ServiceRef=" + MyRef + ",PmaxServiceRef=" + MyPmaxRef;
                        //+ ",UserName=" + MyUser.UserName + ",Password=" + MyUser.Password
                    }
                }
                else
                {
                    string MyDisplay = Mydataaccess.GetAppSetting("DefaultDeviceDisplay");
                    ...
                    if (MyDisplay != "-99")
                    {
                        ...
                        {
                            this.Xaml1.InitParameters = "DisplayID=" + MyDisplay + ",ServiceRef=" + MyRef + ",PmaxServiceRef=" + MyPmaxRef;
                            //+ ",UserName=" + MyUser.UserName + ",Password=" + MyUser.Password
                        }
